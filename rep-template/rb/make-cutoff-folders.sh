...
echo "$tdpath --treefile species_trees.trees --frechetmean --rooted true" >> td-post.slurm
...
echo "$tdpath --treefile species_trees.trees --frechetmean --rooted true" >> td-prior.slurm
...
echo "$tdpath --treefile species_trees.trees --rooted true --reftree ../../../sim/true-species-tree.tre --refrooted true --prefix bhvdists" >> td-true.slurm
