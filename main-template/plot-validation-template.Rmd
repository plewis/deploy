...
#plot(df$observed_means, df$true_heights)

p <- ggplot() +
  geom_point(data = df, aes(true_heights, observed_means), color="blue", alpha = 0.5, cex=0.2) +
  geom_point(data = df, aes(true_heights, observed_means + hpd_maxes - observed_means), color="orange", alpha=0.5) +
  geom_point(data = df, aes(true_heights, observed_means - observed_means + hpd_mins), color="orange", alpha=0.5) +
  geom_linerange(aes(x=true_heights, y=observed_means, ymin=hpd_mins, ymax = hpd_maxes),colour="orange", alpha=0.5, size=1.1) +
