...
do
	...
	echo "$tdpath --treefile gene${SLURM_ARRAY_TASK_ID}.trees --frechetmean --rooted true" >> td-rb-prior.slurm
	...
	echo "$tdpath --treefile gene${SLURM_ARRAY_TASK_ID}.trees --frechetmean --rooted true" >> td-rb-post.slurm
